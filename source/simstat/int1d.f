...
c
     ...
     &   , zt2, zt3, zt4, zt5
     &   , za1, za2, za3, za4, za5
     &   , zx2, zx3, zx4, zx5, zy3, zy4, zsw, zsa
     &   , zq0, zq1, zq2, zq3
     &   , zdx, zdref, zepslon
c
c
...
c
c..linearly extrapolate if necessary
c
        if ( jx-2 .lt. 1  .and.  kextrap .gt. 0 ) 
     &    zm2 = 2.0 * zm3 - zm4
c
        if ( jx+1 .gt. kx  .and.  kextrap .gt. 0 ) 
     &    zm4 = 2.0 * zm3 - zm2
c
        if ( jx-3 .lt. 1  .and.  kextrap .gt. 0 ) then
          zm1 = 2.0 * zm3 - zm5
        endif
c
        if ( jx+2 .gt. kx  .and.  kextrap .gt. 0 ) then
          zm5 = 2.0 * zm3 - zm1
        endif
c
        if ( jx-4 .lt. 1  .and.  kextrap .gt. 0 ) then
          zm0 = 2.0 * zm1 - zm2
        endif
c
        if ( jx+3 .gt. kx  .and.  kextrap .gt. 0 ) then
          zm6 = 2.0 * zm5 - zm4
        endif
c
...
c
        if ( jx-1 .le. 1  .and.  kextrap .gt. 0 ) then
c
          zt5 = 0.5 * ( zm4 + zm5 )
          if ( zw6 + zw4 .gt. zepslon*zdref )
     &      zt5 = ( zw6 * zm4 + zw4 * zm5 ) / ( zw6 + zw4 )
          if ( jx+1 .ge. kx .and. kextrap .lt. 1 ) zt5 = 0.0
c
          zt3 = 2.0 * zt4 - zt5
c
        endif
c
        if ( jx .ge. kx  .and.  kextrap .gt. 0 ) then
c
          zt2 = 0.5 * ( zm1 + zm2 )
          if ( zw3 + zw1 .gt. zepslon*zdref )
     &      zt2 = ( zw3 * zm1 + zw1 * zm2 ) / ( zw3 + zw1 )
          if ( jx-2 .le. 1 .and. kextrap .lt. 1 ) zt2 = 0.0
c
          zt4 = 2.0 * zt3 - zt2
c
        endif
