...
c     Use(Glf)        ! for use on Cray J-90
      include 'glf.m'
...
c external arrays
      ...
      integer jmaxm, jshoot, jmm, i_grad, idengrad,
     >  itport_pt(1:5), i_delay, j, jin, jout, jm,
     >  jpt, jptf, jptt, jj, ii, leigen
     ...
     >  alpha_exp(0:jmaxm),elong_exp(0:jmaxm),
...
c
cbate line added by Bateman on 27 Dec 2001
c
