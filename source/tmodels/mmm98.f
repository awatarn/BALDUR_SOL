...
!| 
!| \begin{center}
!| \Large {\bf Multi-Mode Transport Model MMM98} \\
!| \vspace{1pc} \normalsize
...
!| \end{center}
!| 
!| This file documents a subroutine called {\tt mmm98}, which computes
...
!| MMM98 model is given in reference \cite{bate98a}.
!| 
...
c
c  Call tree: MMM98 calls the following routines
c
...
c
c
c  Multi Mode Model in sbrtn THEORY version MMM98
...
!| subroutine {\tt mmm98} that are needed to complete the rest of the
