c@callglf2db.f
c 22-May-03 Bateman, implemented retuened GLF23 in callglf2db.f
...
c 10-Jan-02 Bateman allowed for array of normalized gradients
c 11-nov-99 Kinsey, precall routine for glf2d.f
************************************************************************
       subroutine callglf2db(
     >                 !INPUTS
     > leigen,         ! eigenvalue solver, default 0 for cgg, >0 for tomsqz solver
     ...
     > idengrad,       ! default 2, for simple dilution
                       ! the following arrays are used when i_grad = 2
     > zpte_m,         ! array of externally provided log grad te w.r.t rho
     > zpti_m,         ! array of externally provided log grad ti w.r.t rho
     > zpne_m,         ! array of externally provided log grad ne w.r.t rho
     > zpni_m,         ! array of externally provided log grad ni w.r.t rho
     > zpte_in,        ! externally provided log gradient te w.r.t rho
                       ! the following scalars are used when i_grad = 1
...
c.......POST CALL TO GLF23
        ...
        if ( lprint_gf .gt. 0 ) then

        write (6,*) ' -------------------------'
        write (6,*) ' jm = ',jm
        write (6,*) ' xky0_gf = ',xky0_gf
        write (6,*) ' rms_theta_gf = ',rms_theta_gf
        write (6,*) ' rlti_gf = ',rlti_gf
        write (6,*) ' rlte_gf = ',rlte_gf
        write (6,*) ' rlne_gf = ',rlne_gf
        write (6,*) ' rlni_gf = ',rlni_gf
        write (6,*) ' rlnimp_gf = ',rlnimp_gf
        write (6,*) ' dil_gf = ',dil_gf
        write (6,*) ' apwt_gf = ',apwt_gf
        write (6,*) ' aiwt_gf = ',aiwt_gf
        write (6,*) ' taui_gf = ',taui_gf
        write (6,*) ' rmin_gf = ',rmin_gf
        write (6,*) ' rmaj_gf = ',rmaj_gf
        write (6,*) ' q_gf = ',q_gf
        write (6,*) ' xnu_gf = ',xnu_gf
        write (6,*) ' betae_gf = ',betae_gf
        write (6,*) ' shat_gf = ',shat_gf
        write (6,*) ' alpha_gf = ',alpha_gf
        write (6,*) ' elong_gf = ',elong_gf
        write (6,*) ' xwell_gf = ',xwell_gf
        write (6,*) ' park_gf = ',park_gf
        write (6,*) ' ghat_gf = ',ghat_gf
        write (6,*) ' gchat_gf = ',gchat_gf
        write (6,*) ' adamp_gf = ',adamp_gf
        write (6,*) ' alpha_star_gf = ',alpha_star_gf
        write (6,*) ' gamma_star_gf = ',gamma_star_gf
        write (6,*) ' alpha_e_gf = ',alpha_e_gf
        write (6,*) ' gamma_e_gf = ',gamma_e_gf
        write (6,*) ' alpha_mode_gf = ',alpha_mode_gf
        write (6,*) ' gamma_mode_gf = ',gamma_mode_gf
        write (6,*) ' alpha_p_gf = ',alpha_p_gf
        write (6,*) ' gamma_p_gf = ',gamma_p_gf
        write (6,*) ' xkdamp_gf = ',xkdamp_gf
        write (6,*) ' yparam_gf = ',yparam_gf
        write (6,*) ' xkyf_gf = ',xkyf_gf
        write (6,*) ' gamma_gf = ',gamma_gf
        write (6,*) ' freq_gf = ',freq_gf
        write (6,*) ' phi_norm_gf = ',phi_norm_gf
        write (6,*) ' diff_gf = ',diff_gf
        write (6,*) ' diff_im_gf = ',diff_im_gf
        write (6,*) ' chii_gf = ',chii_gf
        write (6,*) ' chie_gf = ',chie_gf
        write (6,*) ' exch_gf = ',exch_gf
        write (6,*) ' eta_par_gf = ',eta_par_gf
        write (6,*) ' eta_per_gf = ',eta_per_gf
        write (6,*) ' eta_phi_gf = ',eta_phi_gf
        write (6,*) ' chie_e_gf = ',chie_e_gf
        write (6,*) ' cnorm_gf = ',cnorm_gf
        write (6,*) ' xkymin_gf = ',xkymin_gf
        write (6,*) ' xkymax_gf = ',xkymax_gf
        write (6,*) ' xkyf_k_gf = ',xkyf_k_gf
        write (6,*) ' amassgas_gf = ',amassgas_gf
        write (6,*) ' amassimp_gf = ',amassimp_gf
        write (6,*) ' zimp_gf = ',zimp_gf
        write (6,*) ' nroot_gf = ',nroot_gf
        write (6,*) ' iflagin_gf = ',iflagin_gf
        write (6,*) ' lprint_gf = ',lprint_gf
        write (6,*) ' ikymax_gf = ',ikymax_gf
        write (6,*) ' eigen_gf = ',eigen_gf
