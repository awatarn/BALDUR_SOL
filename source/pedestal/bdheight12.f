...
c details, see section 3.5 in pedestal_models.ps.
c 
c@bdheight12.f
c---:----1----:----2----:----3----:----4----:----5----:----6----:----7-c
c
      subroutine bdheight12 (                                         
...
c
      wped = (1.E+6)*0.0081*(zcurrent**1.41)*(zrmajor**1.37)
     &      *(zploss**0.50)*((znebar*1.E-19)**(-0.15))*(zbtor**0.32)
     &      *(zkappa**1.21)*(zhydmass**0.20)*(Fq**1.61)
c
c..calculate plasma volume
c
...
c
      pped = wped/(0.92*vol)
c
c..calcalate pedestal tempeature (pped = 3nktped)
c
